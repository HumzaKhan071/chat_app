...
class Chat {
  ...
  Chat(this.friendId, {this.conversationId, this.updatedAt, this.friendUsername, this.messages});

  int get unreadMessagesCount {
    return messages?.where((e) => e.authorId == friendId && e.readAt == null).length ?? 0;
  }
